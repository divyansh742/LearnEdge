# LearnEdge Online Education Platform (MERN App)

![Main Page](images/mainpage.png)

## Project Description

LearnEdge is a fully functional ed-tech platform that enables users to create, consume,
and rate educational content. The platform is built using the MERN stack, which includes
ReactJS, NodeJS, MongoDB, and ExpressJS.
LearnEdge aims to provide:
...
In summary, LearnEdge is a versatile and intuitive ed-tech platform that is designed to
...
The LearnEdge ed-tech platform consists of three main components: the front end, the
...
Here is a high-level diagram that illustrates the architecture of the LearnEdge ed-tech
platform:
...
The front end of LearnEdge has all the necessary pages that an ed-tech platform should
...
LearnEdge uses a monolithic architecture, with the backend built using Node.js and
Express.js, and MongoDB as the primary database. 

Features and Functionalities of the Back-end: 
The back end of LearnEdge provides a range of features and functionalities, including:
...
1. Cloud-based media management: LearnEdge uses Cloudinary, a cloud-based media
...
The back end of LearnEdge uses a range of frameworks, libraries, and tools to ensure its
...
The back end of LearnEdge uses a range of data models and database schemas to
...
Overall, the back-end of LearnEdge is designed to provide a robust and scalable solution
...
The LearnEdge platform's API is designed following the REST architectural style. The
...
In conclusion, the REST API design for the LearnEdge ed-tech platform is a crucial part
...
what kind of data it will accept or return. With this API design, LearnEdge will be able to
